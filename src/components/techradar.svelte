...
type discipline = 'QA' | 'Backend' | 'Frontend' | 'iOS' | 'Android' | 'Data Science';

let types = ['QA', 'Backend', 'Frontend', 'iOS', 'Android', 'Data Science'];
...
const androidItems: Item[] = [
    ...
    { name: "Kotlin DSL", discipline: "Android", category: "techniques", phase: "trial" },
...
const dataScienceItems: Item[] = [
    { name: "Hadoop ecosystem", discipline: "Data Science", category: "platform", phase: "adopt" },
    { name: "Python 3 ", discipline: "Data Science", category: "languages", phase: "adopt" },
    { name: "Scala", discipline: "Data Science", category: "languages", phase: "adopt" },
    { name: "Spark", discipline: "Data Science", category: "languages", phase: "adopt" },
    { name: "Pytorch", discipline: "Data Science", category: "languages", phase: "adopt" },
    { name: "Samza", discipline: "Data Science", category: "languages", phase: "adopt" },
    { name: "Data quality ensuring", discipline: "Data Science", category: "techniques", phase: "trial" },
    { name: "Deequ", discipline: "Data Science", category: "techniques", phase: "trial" },
    { name: "Deequ", discipline: "Data Science", category: "languages", phase: "trial" },
    { name: "DataHub", discipline: "Data Science", category: "techniques", phase: "assess" },
    { name: "SuperSet", discipline: "Data Science", category: "techniques", phase: "assess" },
    { name: "Catboost", discipline: "Data Science", category: "techniques", phase: "assess" },
    { name: "Catboost", discipline: "Data Science", category: "tools", phase: "assess" },
    { name: "SuperSet", discipline: "Data Science", category: "tools", phase: "assess" },
    { name: "DataHub", discipline: "Data Science", category: "tools", phase: "assess" },
    { name: "Hadoop MapReduce", discipline: "Data Science", category: "techniques", phase: "hold" },
    { name: "Pig", discipline: "Data Science", category: "techniques", phase: "hold" },
    { name: "Tensorflow", discipline: "Data Science", category: "techniques", phase: "hold" },
    { name: "Annoy", discipline: "Data Science", category: "tools", phase: "hold" },
    { name: "Mahout", discipline: "Data Science", category: "tools", phase: "hold" },
    { name: "Tensorflow", discipline: "Data Science", category: "languages", phase: "hold" },
    { name: "Hadoop MapReduce", discipline: "Data Science", category: "languages", phase: "hold" },
    { name: "Pig", discipline: "Data Science", category: "languages", phase: "hold" },
    { name: "Caffe", discipline: "Data Science", category: "languages", phase: "hold" },
]
...
const onMouseEnter = (evt: MouseEvent, item: Item) => {
    console.log("enter", item.name, evt.currentTarget);
    posX = evt.x;
    posY = evt.y;
    activeItem = item;
    active = true
...
<div class="techradar" class:column1={activeSection}>
    ...
    <!-- cx={generateRandomPoint(item).x} cy={generateRandomPoint(item).y} -->
    {#if active}
